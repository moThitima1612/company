...
<?php include ("connect.php");
    ...
    $sql="SELECT * FROM  `admin` WHERE `id` LIKE '%$search%'";
...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <font size=4>  <div class="collapse navbar-collapse" id="myNavbar">
     ...
     <br>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;สถานะ:สมาชิก  &nbsp;<img src="img/5.png" class="img-circle PM  --></h3>
    </div>
  </div>
</nav>
...
<?php
 //connect db
 include("connect.php");
 $sql = "SELECT * FROM `admin` order by id";  //เรียกข้อมูลมาแสดงทั้งหมด
...

{
  ...
  echo "<td align='left'>" . $row["name"] .  "</td>";
   ...
   echo "<td align='left'><img src='img/" . $row["stsuts"] ." ' width='200' high='250'></td>";

    echo "<td><a  class='btn btn-primary btn-lg' href='product_detail.php?id=$row[id]'role='button'>
